<template>
  ...
  <div id="page-content" class="index-page">
    <!-- ////////////Content Box 01 -->
    <section class="box-content box-1 text-center">
      <div class="no-gutter">
        <div class="col-sm-4 bg-1">
          <div class="box-text">
            ...
            <a class="btn btn-1">Learn More</a>
          </div>
        </div>
    ...
    <!-- ////////////Content Box 04 -->
    <section class="box-content box-4 box-bg-black">
      <div class="no-gutter">
        <div class="col-sm-6">
          <div class="box-image">
      ...
      <div class="no-gutter">
        ...
        <div class="col-sm-6 bg-0">
          <div class="box-text">
            ...
            <p>
              <i class="fa fa-map-marker"></i> My Company Glasgow D04 89GR
            </p>
            <p>
              <i class="fa fa-phone"></i> 800-2345-6789
            </p>
            <p>
              <i class="fa fa-phone"></i> 800-2345-6789
            </p>
            <p>
              <i class="fa fa-envelope-o"></i> info@demolink.org
            </p>
            <p>
              <i class="fa fa-clock-o"></i> 7 Days a week from 9:00 am to 7:00 pm
            </p>
